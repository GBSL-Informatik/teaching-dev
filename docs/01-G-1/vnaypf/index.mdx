...
1. Wenn alle Knoten eine gerade Anzahl Kanten haben, beginnt und endet der Weg an derselben Position. Einen solchen Rundgang nennt man auch einen **Eulerkreis**.
