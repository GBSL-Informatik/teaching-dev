...
Haben alle Knoten eine Gerade Anzahl von Kanten?  :mdi[arrow-right-bold]{.green} Lösbar (Eulerkreis)

Haben alle Knoten eine Gerade Anzahl von Kanten ausser zweien? :mdi[arrow-right-bold]{.blue} Lösbar (Eulerpfad)

Haben 1 oder mehr als 2 Knoten eine ungerade Anzahl von Kanten? :mdi[arrow-right-bold]{.red} Nicht lösbar
