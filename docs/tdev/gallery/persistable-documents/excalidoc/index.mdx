...
Das Plugin wandelt dann
- den Pfad im Markdown-Bild automatisch um ohne das `.new` Suffix
- erstellt eine neue Excalidraw-Zeichnung am angegebenen Pfad (und erstellt ggf. den angegebenen Ordner)
