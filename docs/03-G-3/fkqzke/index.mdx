...
<AdventureOptions>
  ...
  <AdventureOption label="II" nextGuessIn="60">
    ...
    \begin{aligned}
        ...
        &\\
        \text{Zimmernummer für Bus 1: }&\quad 3^k\\
        \text{Zimmernummer für Bus 2: }&\quad 5^k\\
        \text{Zimmernummer für Bus 3: }&\quad 7^k\\
        \text{Zimmernummer für Bus 4: }&\quad 11^k\\
        \text{und so weiter...}&\\
        &\\
        \text{Zimmernummer allgemein: }&\quad (2n+1)^k\\
    \end{aligned}
    $$
  ...
  <AdventureOption label="III" nextGuessIn="60">
    ...
    \begin{aligned}
        ...
        k :&\quad \text{ist ein Element der Natürlichen Zahlen}\\
        &\\
        \text{Jeder Gast geht ins folgende Zimmer}:&\quad n^k\\
        &\\
  ...
  <AdventureOption label="IV" nextGuessIn="60">
    ...
    \begin{aligned}
        ...
        &\\
        \rightarrow \text{Die neuen Gäste gehen in die nun freien Zimmer}\\
    \end{aligned}
    $$
