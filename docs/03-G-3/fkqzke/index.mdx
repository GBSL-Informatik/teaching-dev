...
In unserem Rätsel geht es um ein Gedankensystem, das von Hilbert geschaffen wurde. Stellen Sie sich ein Hotel vor, welches **unendlich viele Zimmer** hat und **vollständig besetzt** ist. Was kann die Rezeption tun, wenn ein neuer Gast ein Zimmer beziehen möchte?
...
<AdventureOptions>
  ...
  <AdventureOption label="II" nextGuessIn="60">
    Man multipliziert die Zimmernummer wieder mit 2, so dass alle ungeraden Zimmer frei sind. Danach belegt man alle Zimmer mit Nummern, welche ungerade Primzahlen sind und ihre Potenzen mit den Gästen aus einem Bus.
    ...
    \text{Zimmernummer für Bus 4: } 11^k\\
    \text{und so weiter}\\
    \text{}\\
