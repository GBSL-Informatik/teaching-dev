...
<AdventureOptions>
  ...
  <AdventureOption label="III" nextGuessIn="60">
    Jeder Gast geht in das Zimmer, welches eine doppelt so hohe Zimmernummer hat. Dadurch sind alle schon vorhandenen Gäste in den geraden Zimmernummern. Die neuen Gäste beziehen die ungeraden Zimmernummern und ihre Potenzen, damit alle Gäste aus allen Bussen Platz haben.
