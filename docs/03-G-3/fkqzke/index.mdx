  ...
  <AdventureOption label="III" nextGuessIn="60">
    ...
    \begin  {aligned}
        ...
        &\\
         ...
         &\\
         \quad &\text{Gäste aus Bus 1 gehen in}: 2^k\\
         \quad &\text{Gäste aus Bus 2 gehen in}: 3^k\\
         \quad &\text{Gäste aus Bus 3 gehen in}: 5^k\\
         \quad &\text{Gäste aus Bus 4 gehen in}: 7^k\\
         \quad &\text{Gäste aus Bus 5 gehen in}: 9^k\\
          \quad &\text{und so weiter...}
        &\\
    \end{aligned}
    $$
