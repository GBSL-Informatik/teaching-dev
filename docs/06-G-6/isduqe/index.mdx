...
**Right-Hand-Algorithmus** :mdi[hand-back-left]{.orange} **(Rechte-Hand-Regel):**
...
• Du kommst **immer zum Ausgang**, **wenn** das Labyrinth **keine “schwebenden” Wände** oder **Inseln** hat.&#x20;
...
**Left-Hand-Algorithmus** :mdi[hand-back-right]{.orange} **(Linke-Hand-Regel):**
