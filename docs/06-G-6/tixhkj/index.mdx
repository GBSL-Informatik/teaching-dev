...
Auf dem Bild befindet man sich bereits in einer Endlosschleife.

a) Beim Auftreffen auf ein Hindernis entscheidet man, ob man nach links oder rechts geht.

b) Die erste Entscheidung bestimmt, ob man bei einer Linkskurve **1 addiert** oder **1 subtrahiert**. Diese Zahlen beziehen sich nich auf das vorherige Rätsel, sondern auf den Wert der Richtung!
