...
import Option from '@tdev-components/Adventure/Option'
...
<Option label="a" nextGuessIn={5000}>
  ![--width=125](./images/option-a.jpg)

  ***

  ![--width=525](./images/option-a.jpg)
  Hello
</Option>


<Option label="b" nextGuessIn={5000}>
  ![--width=125](./images/option-b.jpg)
</Option>


<Option label="c" nextGuessIn={5000}>
  ![--width=125](./images/option-c.jpg)
</Option>


<Option label="d" nextGuessIn={5000}>
  ![--width=125](./images/option-d.jpg)
</Option>


<Option label="e" nextGuessIn={5000}>
