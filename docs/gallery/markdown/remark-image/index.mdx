...
![--width=465](./images/binary-counter.gif)
...
<BrowserWindow>
  ![Streetfood Festival Streetfood Festival --width=450px](../images/street-food.jpg)
</BrowserWindow>
...
<BrowserWindow>
  ![Schneebedeckte Strasse Schneebedeckte Strasse --width=450px --inlineCaption=true](../images/snowy-street.jpg)
</BrowserWindow>
...
<BrowserWindow>
  ![**Fett**, *Kursiv*, :mdi[laptop]{.red}, __boxed__, `Code` und [Links](#formatierung-der-bildunterschrift) Fett, Kursiv, laptop, boxed, Code und Links --width=450px](./images/fat-cursive-code.jpg)
</BrowserWindow>
