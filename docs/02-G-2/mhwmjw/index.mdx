...
Hier ist die Karte von Biel mit den Zielen, wichtigen Punkten und allen Routen, die du brauchst:

![--width=700](./images/Karte-Google-01-01.png)

Hier ist die vereinfachte Skizze mit allen Routen und den Energie-Credits:

![](./images/Karte_Zeichenflaeche-1_Zeichenflaeche-1.png)
...
Tipp: Schaue dir die einzelnen Routen an und suche immer die kürzeste aus. Am Ende setzt du alles zusammen und kriegst somit den kürzesten Weg! Erstelle dafür eine Tabelle. Hier eine Hilfe
...
<AdventureOptions>
  <AdventureOption label="A" nextGuessIn={10}>
    Energie-Credits A
  ...
  <AdventureOption label="B" nextGuessIn={10}>
    Energie-Credits B
  ...
  <AdventureOption label="C" nextGuessIn={10}>
    Energie-Credits C
  ...
  <AdventureOption label="D" nextGuessIn={10}>
    Energie-Credits D
  ...
  <AdventureOption label="E" nextGuessIn={10}>
    Energie-Credits E
