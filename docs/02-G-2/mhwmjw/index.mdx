...
<AdventureOptions>
  <AdventureOption label="A" nextGuessIn={2}>
    ...
    Ob die Antwort A die richtige ist, findest du heraus durch das scannen des QR-Codes im D-Gebäude, .
  ...
  <AdventureOption label="B" nextGuessIn={2}>
    ...
    Ob die Antwort B die richtige ist, findest du heraus durch das scannen des QR-Codes im D-Gebäude, .
  ...
  <AdventureOption label="C" nextGuessIn={3}>
    ...
    Ob die Antwort C die richtige ist, findest du heraus durch das scannen des QR-Codes im D-Gebäude, .
  ...
  <AdventureOption label="D" nextGuessIn={4}>
    ...
    Ob die Antwort D die richtige ist, findest du heraus durch das scannen des QR-Codes im D-Gebäude, .
  ...
  <AdventureOption label="E" nextGuessIn={5}>
    ...
    Ob die Antwort E die richtige ist, findest du heraus durch das scannen des QR-Codes im D-Gebäude, .
