...
import Reset from '@tdev/script/components/Actions/Reset';
import DownloadCode from '@tdev/script/components/Actions/DownloadCode';
import ShowRaw from '@tdev/script/components/Actions/ShowRaw';
import RunCode from '@tdev/script/components/Actions/RunCode';
