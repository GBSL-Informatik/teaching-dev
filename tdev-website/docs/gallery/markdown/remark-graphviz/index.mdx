...
### Binärbaum
<CodeShowcase lang="md" collapseCode>
```dot
...
<CodeShowcase lang="md" collapseCode>
Beispiel von https://graphviz.org/Gallery/gradient/cluster.html
...
<CodeShowcase lang="md" collapseCode>
Beispiel von https://graphviz.org/Gallery/directed/datastruct.html
...
<CodeShowcase lang="md" collapseCode>
Beispiel von https://graphviz.org/Gallery/neato/transparency.html
```dot
graph Transparency {
	layout=neato
...
<CodeShowcase lang="md" collapseCode>
Beispiel von https://graphviz.org/Gallery/directed/fsm.html
```dot
...
<CodeShowcase lang="md" collapseCode>
Beispiel von https://graphviz.org/Gallery/directed/Genetic_Programming.html
```dot
graph {
    fontname="Helvetica,Arial,sans-serif"
    node [fontname="Helvetica,Arial,sans-serif"]
...
<CodeShowcase lang="md" collapseCode>
Beispiel von https://graphviz.org/Gallery/directed/psg.html
```dot
digraph g {
