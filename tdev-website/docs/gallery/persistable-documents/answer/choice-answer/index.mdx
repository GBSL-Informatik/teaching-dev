...
<BrowserWindow>
    <ChoiceAnswer correct={[2]} id="3f78aec5-a39e-4119-9a9d-783f9edb9488">
        > Wer gilt als Erfinder des World Wide Web (WWW)?
...
<BrowserWindow>
    <ChoiceAnswer correct={[2]} randomizeOptions id="6e275c2d-4301-43b0-9b30-c6cd03a4c72f">
        > Wir gilt als Erfinder des World Wide Web (WWW)?!
...
<BrowserWindow>
    <ChoiceAnswer correct={[1, 4, 5]} multiple  title="Eine Frage zu den Primzahlen" id="0b05ea40-4235-4d51-8b30-2a23e045c169">
        > Welche der folgenden Aussagen zu Primzahlen sind korrekt? Es sind **mehrere** Antworten möglich.
...
<BrowserWindow>
    <TrueFalseAnswer correct={false} title="Das sollte man wissen…" id="43b12b71-150e-4428-b86f-050f4fe52a52">
        Die Erde ist flach.
    </TrueFalseAnswer>
</BrowserWindow>
...
<BrowserWindow>
    <ChoiceAnswer title="Geo-Wissen" correct={[2]} scoring={points(1)} id="b05ff2c3-393d-4978-8fe8-2b70260237ae">
        > Was ist die Hauptstadt von Frankreich?
    ...
    <ChoiceAnswer title="Primzahlen" multiple correct={[2, 3, 5]} scoring={multipleChoicePoints(2, 1)} id="0fca03bf-f2a5-4275-8684-6df8539c754b">
        > Wählen Sie alle Primzahlen aus.
    ...
    <TrueFalseAnswer correct={true} scoring={points(0.5, -0.25, 0)} id="51f7951e-ebd4-4c60-aa43-8023324273c9">
        > Das Protokoll `HTTP` gehört zur Anwendungsschicht des TCP/IP-Stacks.
...
<BrowserWindow>
    <Quiz scoring={points(1)} randomizeQuestions randomizeOptions id="b07dc196-94a9-40c3-8c05-4c3bebd509f4" >
        <ChoiceAnswer correct={[5]}>
            > In welchem Jahr war 2024?
