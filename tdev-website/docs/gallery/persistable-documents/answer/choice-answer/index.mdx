...
<BrowserWindow>
    <TrueFalseAnswer correct={false} title="Das sollte man wissen…" id="4227646b-458a-418b-9809-f341fd9e640d">
        Die Erde ist flach.
    </TrueFalseAnswer>
</BrowserWindow>
...
<BrowserWindow>
    ...
    <TrueFalseAnswer correct={true} scoring={points(0.5, -0.25, 0)} id="7497ea4d-adbe-4b7e-8353-b2bcd12f796b">
        > Das Protokoll `HTTP` gehört zur Anwendungsschicht des TCP/IP-Stacks.
    </TrueFalseAnswer>
</BrowserWindow>
...
<BrowserWindow>
    <Quiz scoring={points(1)} randomizeQuestions randomizeOptions id="7b9dfd17-2ddb-4b71-8a5a-43f556ba5152" >
        <ChoiceAnswer correct={[5]}>
            > In welchem Jahr war 2024?
