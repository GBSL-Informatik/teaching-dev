...
export const Imports = {
    Quiz: `import Quiz from '@tdev-components/documents/Assessable/Quiz';`,
    ChoiceAnswer: `import ChoiceAnswer from '@tdev-components/documents/Assessable/ChoiceAnswer';`,
    TrueFalseAnswer: `import TrueFalseAnswer from '@tdev-components/documents/Assessable/TrueFalseAnswer';`,
    ScoringFn: (fn = 'points, multipleChoicePoints') => `import { ${fn} } from '@tdev-components/documents/Assessable/helpers/scoring';`,
    Hints: `import Hint from '@tdev-components/documents/Assessable/Feedback/Hint';`,
}
...
<CodeShowcase lang="tsx" imports={[Imports.ChoiceAnswer]}>
...
<CodeShowcase lang="tsx" imports={[Imports.TrueFalseAnswer]}>
...
<CodeShowcase lang="tsx" imports={[Imports.ChoiceAnswer, Imports.TrueFalseAnswer, Imports.ScoringFn()]}>
...
<CodeShowcase lang="tsx" imports={[Imports.ChoiceAnswer, Imports.TrueFalseAnswer, Imports.Quiz, Imports.ScoringFn('points, multipleChoicePoints, noPoints')]}>
...
## Testing Only
Dummy Quiz zum Test des Fixes.

<Quiz scoring={points(1)} randomizeQuestions randomizeOptions resetMode="incorrect" id="e4fd5d0b-f5b0-4722-8452-ca78f1de0aa1" >
    <ChoiceAnswer correct={[1]}>
        1. Diese Antwort ist richtig.
        2. Diese Antwort ist falsch.
        3. Diese Antwort ist Blödsinn.
        4. Diese Antwort ist nicht korrekt.
    </ChoiceAnswer>
    ...
    <ChoiceAnswer correct={[2, 4]} multiple scoring={multipleChoicePoints(2, 1, false)}>
        Wähle alle Farben an.
