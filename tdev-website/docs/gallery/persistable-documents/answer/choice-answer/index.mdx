...
|------------------|-------------------|---------------------------------------------------|
| `title` | `string` | Titel der Frage. Wird im Header der Frage angezeigt. Standard: 'Frage' |
| `keepExpanded` | `all | correct | selected | none` | Steuert, welche Antwortmöglichkeiten nach der Beantwortung der Frage angezeigt werden. Standard: `all`. |
