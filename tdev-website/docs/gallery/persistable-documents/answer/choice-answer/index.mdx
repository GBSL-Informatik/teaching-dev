...
<Quiz id="05ff4108-a75d-4978-9b0f-d06be05fc1bf" scoring={points(1)}>
  ...
  <ChoiceAnswer correct={[1, 3]} scoring={(partialPoints())} multiple>
...
<BrowserWindow>
    <Quiz id="05ff4108-a75d-4978-9b0f-d06be05fc1bf" scoring={points(1)}>
        ...
        <ChoiceAnswer correct={[1, 3]} scoring={(multipleChoicePoints())} multiple>
            > Welche der folgenden Protokolle werden für die Übertragung von E-Mails verwendet?
