...
<Quiz scoring={points(1)} id="04d2153f-1ed3-41bd-835b-a8bebe2ca6e8" randomizeQuestions randomizeOptions>
...
<BrowserWindow>
    <Quiz scoring={points(1)} randomizeQuestions randomizeOptions id="8ff62462-ba6c-4c90-96bc-a50e177a67a8" >
        <ChoiceAnswer correct={[5]}>
            > In welchem Jahr war 2024?
