---
page_id: 1fa96de2-9d97-4069-813d-d732bb6fb8cd
tags:
  - bilder
  - codierung
---
...
export const IMP = `import Excalidoc from '@tdev/excalidoc/Component';`
...
<CodeShowcase imports={[`import ExcalidocWithCodeEditor from '@tdev/excalidoc/Component/WithCodeEditor';`]}>
