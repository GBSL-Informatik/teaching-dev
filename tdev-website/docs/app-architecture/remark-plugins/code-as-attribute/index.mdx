...
oder mit dem effektiven Code einer Komponente:

:::flex{minWidth=250px}
#### Vorher
````md
# Remark Raw Code as Attribute
...
Das Plugin kann wie folgt konfiguriert werden:
```ts title="markdown plugin config"
...
// highlight-start
const codeAsAttributePluginConfig = [
